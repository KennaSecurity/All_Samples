...
vuln_age = 37  # replace 37 with the custom field for age from your environment
vuln_age_range = 38  # replace 38 with the custom field for range from your environment
